...
func (qs *onlineAccountsDbQueries) LookupOnlineTotalsHistory(round basics.Round) (basics.MicroAlgos, basics.Scores, error) {
	...
	return basics.MicroAlgos{Raw: data.OnlineSupply}, data.ScoresSupply, err
}
