...
func (m *mockedLedger) Circulation(basics.Round) (basics.MicroAlgos, basics.Scores, error) {
	return basics.MicroAlgos{}, basics.Scores{}, errors.New("not needed for mockedLedger")
}
